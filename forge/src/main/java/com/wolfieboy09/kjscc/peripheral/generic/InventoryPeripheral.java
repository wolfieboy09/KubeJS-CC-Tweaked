...
public class InventoryPeripheral extends PeripheralJS {
    ...
    public Object getItemDetail (BlockContainerJS block, Direction side, @NotNull List<?> arguments, IComputerAccess computer, ILuaContext context) throws LuaException {
    ...
    public Object getItemLimit (BlockContainerJS block, Direction side, @NotNull List<?> arguments, IComputerAccess computer, ILuaContext context) throws LuaException {
        int arg0 = Utils.castObjToInt(arguments.get(0), "Slot must be a valid integer");
        return invMethods.getItemLimit(Utils.getItemHandler(block), arg0);
    }

    public Object pushItems (BlockContainerJS block, Direction side, @NotNull List<?> arguments, IComputerAccess computer, ILuaContext context) throws LuaException {
    ...
    public Object pullItems (BlockContainerJS block, Direction side, @NotNull List<?> arguments, IComputerAccess computer, ILuaContext context) throws LuaException {
